...
namespace InsanKaynaklari.MVC.Areas.CompanyManager.Controllers
{
    ...
    public class EmployeeController : Controller
    {
			...
			if (ModelState.IsValid)
			{
				...
				if (checkForEmail == null)
				{
					...
					if (result.Succeeded)
					{
						...
						{
							ModelState.AddModelError(string.Empty, "An error occurred during role definition.");
						}
				...
				{
					ModelState.AddModelError(string.Empty, "Such an e-mail is registered in the system.");
				}
			}
		...
		public async Task<IActionResult> SendMail(string eMail)
		{
			...
			{
				return StatusCode(StatusCodes.Status404NotFound, new Status() { StatusString = "Başarısız", Message = "Mail Not Found!" });
			}
		}
	}
